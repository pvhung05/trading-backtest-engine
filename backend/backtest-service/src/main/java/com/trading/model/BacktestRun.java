...
public class BacktestRun {
    ...
    private BacktestRun(Long userId, StrategyType strategyType, String strategyParams,
    ...
    public static BacktestRun of(Long userId, StrategyType strategyType, String strategyParams,
                                 String symbol, String timeframe, Instant startTime, Instant endTime) {
        return new BacktestRun(userId, strategyType, strategyParams, symbol, timeframe, startTime, endTime);
    }
