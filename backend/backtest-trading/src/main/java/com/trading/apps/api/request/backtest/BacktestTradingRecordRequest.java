package com.trading.apps.api.request.backtest;
...
/**
 * Request DTO for executing a backtest and retrieving the trading-record chain.
 */
@Data
public class BacktestTradingRecordRequest {
    ...
    public BacktestCommand toDomainCommand() {
        ...
        return BacktestCommand.builder()
