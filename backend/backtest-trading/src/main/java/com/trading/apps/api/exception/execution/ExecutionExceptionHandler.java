package com.trading.apps.api.exception.execution;
...
/**
 * Centralized exception handler for execution API endpoints.
 */
@RestControllerAdvice(basePackages = "com.trading.apps.api.controller.execution")
